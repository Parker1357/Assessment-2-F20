...
class Employee {
    ...
    getSchedule(){
      console.log('My name is', this.name, 'and I work the', this.shifts, 'and I love it!');
    }
}
...
//CODE HERE
let Employee1 = new Employee('Parker', 'Nights')
let Employee2 = new Employee('Tim', 'Day')

console.log(Employee1.name)
console.log(Employee1.shifts)
console.log(Employee2.name)
console.log(Employee2.shifts)
...
class Employee {
  ...
  class Manager extends Employee {
    constructor(name, shifts, Employees) {
      ...
      this.Employees = [Parker, Tim, Rachel, Miranda]
    }
  
    getMangersEmployees(){
        console.log('My name is', this.name, 'and I work the', this.shifts, 'and my employees who work under me are', this.Employees!');
      }
  }
